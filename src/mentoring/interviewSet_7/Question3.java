...
public class Question3 {
    public static void main(String[] args) {
        /*
        3. blogDb gets an ArrayList of String Arrays(ArrayList<String[]>) from a database,
        ...
        ArrayList<String[]> r example. Each item in ArrayList is a String ArrayList r = [["1","title","content1"],
        ["2","another title","content2"], ["3","yet another title","content3"]]
    ...
    public static void blogDb(ArrayList<String[]> r){
