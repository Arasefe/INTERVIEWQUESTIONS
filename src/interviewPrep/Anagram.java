...
public class Anagram {
    ...
    public static boolean anagram4(String str1, String str2){
        char[]ch1=str1.toLowerCase().toCharArray();
        char[]ch2=str2.toLowerCase().toCharArray();
    ...
    public static boolean anagram5(String str1, String str2){
    ...
    public static void anagram6(String str1,String str2){
        /*
        Sorts the elements is natural order (ascending)
         */
    ...
    public static void anagram7(String str1,String str2){
